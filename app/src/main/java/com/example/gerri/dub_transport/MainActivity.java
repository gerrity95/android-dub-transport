...
public class MainActivity extends AppCompatActivity {
    ...
    public class GetBitmapFromURLAsync extends AsyncTask<String, Void, Bitmap> {
        ...
        protected void onPostExecute(Bitmap bitmap) {
            try {
                ...
                setBackgroundAnimations(bitmap, backgroundImageView);
            } catch (Exception e) {
    ...
    public void setBackgroundAnimations(Bitmap bitmap, ImageView backgroundImageView) {
        //ImageView backgroundImageView = findViewById(id);
    ...
    public void toLuas(View view)
    {
        Intent intent = new Intent(MainActivity.this, LuasHomeActivity.class);
        startActivity(intent);
    }

    public void toDubBus(View view)
    {
        Intent intent = new Intent(MainActivity.this, DubBusHomeActivity.class);
        startActivity(intent);
    }
